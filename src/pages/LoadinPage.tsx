...
const LoadingPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen w-screen items-center justify-center bg-gradient-to-br from-indigo-50 via-indigo-100 to-indigo-200 dark:bg-gray-900 dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 transition-colors duration-500">
      {/* Embedded CSS for the Pencil Animation */}
      <style>
        {`
          .pencil {
            display: block;
      ...
      <div className="flex flex-col items-center space-y-8">
        {/* App Logo (Optional, removed to focus on pencil, uncomment if needed) */}
        {/* <img src="/images/logo.png" alt="Brillia Logo" className="h-16 w-16 mb-4" /> */}

        {/* The Pencil Loader SVG */}
        <div className="scale-125">
          ...
          >
            ...
            <circle
              ...
              fill="none"
              r="70"
              className="pencil__stroke text-indigo-900 dark:text-indigo-400"
            ></circle>
        ...
        <p className="dark:text-indigo-200 text-indigo-900 text-xl font-medium tracking-wide animate-pulse">
          Loading content...
        </p>
      </div>
    </div>
