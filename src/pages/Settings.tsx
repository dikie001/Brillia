...
import { 
  Bell, Moon, Sun, User, Volume2, Settings as SettingsIcon, 
  Shield, Trash2, RotateCcw, Info, Edit2, Lock, Unlock 
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/50 to-purple-50/50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 dark:text-white transition-colors duration-500 relative overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 left-10 w-[500px] h-[500px] bg-purple-400/20 dark:bg-purple-600/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 pt-24">
        ...
        <div className="mb-10 text-center lg:text-left">
           ...
           <p className="text-gray-500 dark:text-gray-400 mt-2 font-medium">Manage your preferences and account details</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <aside className="lg:col-span-4 space-y-6 lg:sticky lg:top-28 animate-in fade-in slide-in-from-left-4 duration-700">
              ...
              <CardContent className="relative pt-0 px-6 pb-6">
                <div className="flex justify-between items-end -mt-12 mb-4">
                  <div className="h-24 w-24 rounded-2xl bg-white dark:bg-gray-800 p-1.5 shadow-lg rotate-3 group-hover:rotate-0 transition-transform duration-300">
                    <div className="h-full w-full rounded-xl bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-gray-700 dark:to-gray-600 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">{hobby || "Learning enthusiast"}</p>
            ...
            <Card className="border-white/40 dark:border-gray-700/50 bg-white/40 dark:bg-gray-800/30 backdrop-blur-md">
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-800 dark:text-gray-200">Brillia v1.0</p>
          ...
          <div className="lg:col-span-8 space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 ml-1">Appearance & Sounds</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <CardContent className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`p-3 rounded-xl shadow-inner ${theme === 'light' ? 'bg-amber-100 text-amber-600' : 'bg-indigo-950 text-indigo-400'}`}>
                ...
                >
                  <CardContent className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`p-3 rounded-xl shadow-inner ${soundsEnabled ? 'bg-blue-100 text-blue-600' : 'bg-gray-200 text-gray-500'}`}>
                        <Volume2 className="w-6 h-6" />
                      </div>
                      <div className="text-left">
                        <p className="font-semibold text-gray-900 dark:text-white">Sounds</p>
                        <p className="text-xs text-gray-500">{soundsEnabled ? 'On' : 'Off'}</p>
                      </div>
                    </div>
                    <div className={`w-3 h-3 rounded-full ${soundsEnabled ? 'bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)]' : 'bg-gray-300'}`} />
                  </CardContent>
                </Card>
              </div>
               ...
               <Card className="border-white/40 dark:border-gray-700/50 bg-white/60 dark:bg-gray-800/40 backdrop-blur-md opacity-80">
                  <CardContent className="p-4 flex items-center justify-between">
                    ...
                    <span className="text-xs bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded text-gray-500">Coming Soon</span>
                  </CardContent>
               </Card>
            </div>
