    ...
    <div className="relative w-full mb-6 px-4 sm:px-0">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute top-12 sm:top-12 left-0 sm:left-auto right-0 sm:right-auto bg-white dark:bg-gray-800 shadow-xl rounded-xl p-1 border border-gray-200 dark:border-gray-700 z-50 sm:min-w-48 mx-4 sm:mx-0">
            {genres.map((genre) => (
              <button
                key={genre}
